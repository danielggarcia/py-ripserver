...
octave = Oct2Py(None, None, 120, 'row', '/opt/robot/tmp')
...
class RIPOctave(RIPGeneric):
  ...
  def saveCurrentData(self):
    #Load a mat file
    # contents = sio.loadmat('/home/pi/octavetmp.mat')
    
    #Access to data
    # dataArray = contents['dataArray']
    # elements = len(contents['dataArray'][0])
    
    #Save mat file
    # sio.savemat('/home/pi/frompython.mat',{'mimatriz':mimatriz}, {'mimatriz2':mimatriz2})
    return 0
